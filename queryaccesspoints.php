...
include 'config.php.inc'; 
        ...
        $ap_search = "SELECT * FROM `wireless2`.`nas` WHERE (CONVERT( `nasname` USING utf8 ) LIKE '%$search%' OR CONVERT( `shortname` USING utf8 ) LIKE '%$search%') ORDER BY $order LIMIT 0 , 30";
