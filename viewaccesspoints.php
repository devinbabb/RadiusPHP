...
include 'config.php.inc'; 
	...
	$selection = $_POST["sortaps"];
		
		if ($selection=="shortname")
			$order = "shortname";
		elseif ($selection=="ipaddress")
			$order = "nasname";
		else
			$order = "id";
    ...
    $execute = mysql_connect($mysql_host, $mysql_user, $mysql_pass) or die(mysql_error());
        ...
        $query = "SELECT * FROM nas ORDER BY $order";
        $result = mysql_query($query) or die(mysql_error());
?><table border="1" bordercolor=GREEN align="center" width="1000px"><tr><td width="33%" align="center"><font size=+2><u><b>Shortname (Alias)</u></b></font></td><td width="34%" align="center"><font size=+2><u><b>Access Point IP</u></b></td></font><td width="33%" align="center"><font size=+2><u><b>Secret</u></b></font></td></tr><?php
        while($row = mysql_fetch_array($result)) {
        echo "<tr><td width=\"25%\" align=\"center\">".$row['shortname']. "</td><td width=\"25%\" align=\"center\">". $row['nasname']."</td><td width=\"25%\" align=\"center\">". $row['secret']."</td></tr>";
        }
?></table><?php
